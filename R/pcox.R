...
#' 
#' @param formula a formula with special terms as for \code{\link[mgcv]{gam}}, with
#' additional special terms allowed. See Details.
#' @param method method used to optimize the smoothing parameter(s). See Details.
#' @param eps convergence level for the criterion indicated by \code{method}.
#' @param knots optional list containing the user-specified knot values for basis
#' construction, as in \code{\link[mgcv]{gam}}.
#' @details This routine is a wrapper for either \code{\link[survival]{coxph}} or
...
#' @return a fitted \code{pcox} object. This is either a \code{coxph} or \code{coxme} object with
#'    additional information in the \code{pcox} entry.
#' @references Gellar, Jonathan E., Colantuoni, Elizabeth, Needham, Dale M., and Crainiceanu,
...
#' @seealso \code{mgcv}'s \code{\link[mgcv]{smooth.terms}} for details of \code{mgcv} syntax and
