...
#' 
#' 
#' @format \code{sofa} is data frame with 520 rows (subjects) and 7 variables:
#' \describe{
...
#' }
#' 
#' \code{sofa_fu} contains the follow-up data for the 267 subjects who survived
#'   their initial hospitalization (\code{death==FALSE}). It contains 6 of the
#'   7 variables from \code{sofa} (all except \code{death}), as well as the
#'   following:
#' \describe{
#'   \item{event}{binary indicator of death during follow-up. \code{FALSE}
#'     indicates censoring.}
#'   \item{time}{follow-up time for the subject, until death or censoring.}
#'   \item{SOFA_ds}{domain-standardized version of \code{sofa$SOFA}}
#' }
#' 
#' @references 
